...
const CourseTeacherController_1 = require("../controllers/CourseTeacherController");
...
router.get('/profesor/:professorId/alumnos', CourseTeacherController_1.getStudentsByteacher);
